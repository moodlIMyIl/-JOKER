...
bot_token = "486158904:AAG7z40sFb9VJCB_AoJ940Y-vHMKo2h-ZKo" --Put You Token Here
...
function create_config( )
	...
	if server_user:match("^root$") then
		MeGaPlusTeaM = '/root/Mcli'
	elseif not server_user:match("^root$") then
		MeGaPlusTeaM = '/home/'..server_user..'/Mcli'
	end
  ...
  config = {
    ...
    sudo_users = {468354860,448191863},--Sudo users
    admins = {},
    disabled_channels = {},
    moderation = {data = ''..MeGaPlusTeaM..'/data/moderation.json'},
    info_text = [[* ➲ MeGa Helper Bot V8.1*

* ➲ Admins :*
* ➲ Founder & Developer :* [NASA](Telegram.Me/kiarashNASA)

* ➲ Our channel :*
➲ [MeGaPlus TeaM](Telegram.Me/MeGaPlusTeaM)
]],
  }
